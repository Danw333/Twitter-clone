    ...
    <div className="hidden lg:flex flex-col ml-7 mt-4">
      ...
      <div className="w-[300px] h-[500px] bg-white bg-opacity-10 rounded-3xl mt-3">
        ...
        <div className="p-3 relative">
          ...
          <p className="text-xs text-gray-500">940K Tweets</p>
        </div>
        <div className="p-3 relative">
          <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
          <p className="text-xs text-gray-500">Trending in Sports</p>
          <h1 className="text-[15px] font-bold">Football</h1>
          <p className="text-xs text-gray-500">810K Tweets</p>
        </div>
        <div className="p-3 relative">
          <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
          <p className="text-xs text-gray-500">Trending in Science</p>
          <h1 className="text-[15px] font-bold">Secret Fossils</h1>
      ...
      <div className="w-[300px] h-[300px] bg-white bg-opacity-10 rounded-3xl mt-3">
        ...
        <div className="flex justify-between p-3">
          <div className="flex space-x-3">
            <img
              className="w-11 h-11 object-cover rounded-full"
              src="/assets/Danwelsh.jpg"
            />
            <div>
              <div className="flex space-x-1">
                <h1 className="font-bold">Daniel Welsh</h1>
                <BadgeCheckIcon className="w-[18px] text-blue-400" />
              </div>
              <h1 className="text-[12px] mt-1 text-gray-500">@danielwelsh</h1>
            </div>
          </div>
